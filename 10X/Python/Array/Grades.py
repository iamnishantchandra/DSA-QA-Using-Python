'''
Grades
Suppose 10x Academy is planning a new grading system. It will be as follows:

Every student receives a grades in the inclusive range from 0 to 100.
Any grade less than 40 is a failing grade.
We also want to round each student's grade according to these rules:
...
Output Format
Modified Grade of the students as one integer on each line.
